...
let wizzardHero = new Hero('wizzard', 12, 150, 250, '')
let swordmanHero = new Hero('swordman', 4411, 31400, 14550, '')

let spiderHero = new Hero('spider', 100)
let dragonHero = new Hero('dragon', 200)
let charmerHero = new Hero('charmer', 150)
let pirateHero = new Hero('pirate', 180)
let alienHero = new Hero('alien', 480)
let janissaryHero = new Hero('janissary', 280)
let devilHero = new Hero('devil', 300)
let builderHero = new Hero('builder', 300)
let cowboyHero = new Hero('cowboy', 300)
let jokerHero = new Hero('joker', 300)
let ladyHero = new Hero('lady', 300)
let gangsterHero = new Hero('gangster', 300)
let nukemanHero = new Hero('nukeman', 300)
let snowmanHero = new Hero('snowman', 300)
let cookHero = new Hero('cook', 300)
let kungHero = new Hero('kung', 300)
let thiefHero = new Hero('thief', 300)
let clownHero = new Hero('clown', 300)
let deathHero = new Hero('death', 300)
let rocketmanHero = new Hero('rocketman', 300)
...
document.getElementById(monsters[getRndInteger(0,19)].id).style.display = 'block'
document.getElementById(monsters[getRndInteger(0,19)].id).style.display = 'block'
document.getElementById(monsters[getRndInteger(0,19)].id).style.display = 'block'
document.getElementById(monsters[getRndInteger(0,19)].id).style.display = 'block'
document.getElementById(monsters[getRndInteger(0,19)].id).style.display = 'block'
    ...
    if(!selectedHero) {
        ...
        if(selectedWeapon && selectedEnemy && selectedHero) {  
            ...
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'janissary') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createJanissary, "../sound/janissary.mp3", "yellow")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'devil') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createDevil, "../sound/devil.mp3", "red")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'builder') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createBuilder, "../sound/builder.mp3", "blue")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'cowboy') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createCowboy, "../sound/cowboy.mp3", "green")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'joker') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createJoker, "../sound/joker.mp3", "green")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'lady') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createLady, "../sound/lady.mp3", "green")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'gangster') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createGangster, "../sound/gangster.mp3", "green")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'nukeman') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createNukeman, "../sound/nukeman.mp3", "green")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'snowman') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createSnowman, "../sound/snowman.mp3", "green")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'cook') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createCook, "../sound/cook.mp3", "green")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'kung') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createKung, "../sound/kung.mp3", "green")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'thief') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createThief, "../sound/thief.mp3", "green")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'clown') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createClown, "../sound/clown.mp3", "green")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'death') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createDeath, "../sound/death.mp3", "green")
            }
            if (selectedHero.name == 'wizzard' && selectedEnemy.name == 'rocketman') {
                heroAtack(20,createMagic, "../sound/magic.mp3", "#191970",createRocketman, "../sound/rocketman.mp3", "green")
            }
            ...
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'janissary') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createJanissary, "../sound/janissary.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'devil') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createDevil, "../sound/devil.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'builder') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createBuilder, "../sound/builder.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'cowboy') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createCowboy, "../sound/cowboy.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'joker') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createJoker, "../sound/joker.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'lady') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createLady, "../sound/lady.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'gangster') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createGangster, "../sound/gangster.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'nukeman') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createNukeman, "../sound/nukeman.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'snowman') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createSnowman, "../sound/snowman.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'cook') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createCook, "../sound/cook.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'kung') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createKung, "../sound/kung.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'thief') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createThief, "../sound/thief.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'clown') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createClown, "../sound/clown.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'death') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createDeath, "../sound/death.mp3", "green")
            }
            if (selectedHero.name == 'swordman' && selectedEnemy.name == 'rocketman') {
                heroAtack(350, createClash, "../sound/sword.wav", "purple", createRocketman, "../sound/rocketman.mp3", "green")
            }
