...
let swordmanHero = new Hero('swordman', 11, 1400, 1550, '')
     ...
     if (selectedHero.weapon.length < 2) {
        ...
        function selectedWeaponAction() {
            ...
            menuSelWeapon.innerText = weapon 
                   ...
                   console.log(weapon);
                   console.log(document.querySelector(`.${weapon}`));
...
function enemyAtackAction() {
    ...
    if(selectedWeapon && selectedEnemy && selectedHero) {
        ...
        setTimeout(() => {
            ...
            const enemyDispNone = []
            const enemyDivs = [spider, dragon, charmer, pirate, alien]
            const enemyHeroes = [spiderHero, dragonHero, charmerHero, pirateHero, alienHero]
            const enemyHealthDivs = [spiderHealth, dragonHealth, charmerHealth, pirateHealth, alienHealth]
